...
const SKIP_DIRS = new Set([
  ...
  /* Панель для сотрудников и её серверная часть. Это не страницы сайта:
     у них нет ни языковых версий, ни микроразметки, и обходить их
     инструментам сайта незачем. */
  "admin", "api",
