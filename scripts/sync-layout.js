...
const ROUTE_SETS = {
  wide: {
    ...
    routes: [
      ...
      /* Москва заполняет пустоту в середине верха. Её кривая подобрана
         расчётом: она идёт почти отвесно и держится в 39 единицах и от
         берлинской, и от пекинской — это больше, чем между некоторыми
         из остальных пар, так что слиться им не с чем. */
      { key: "moscow",   d: "M196 648 C 200 430, 225 200, 216 84",  len: 565, x: 216, y: 84,  labelY: 44,  draw: 800,  delay: 3500, dur: "10.5s" },
      { key: "beijing",  d: "M196 648 C 250 520, 330 320, 344 152", len: 520, x: 344, y: 152, labelY: 114, draw: 1100, delay: 4600, dur: "12.5s" },
      { key: "dubai",    d: "M196 648 C 286 604, 352 540, 350 430", len: 284, x: 350, y: 430, labelY: 392, draw: 1400, delay: 5700, dur: "10s" }
    ]
  },
  narrow: {
    box: [420, 260],
